...
const Waves = ({
  ...
  useEffect(() => {
    ...
    function syncPlayback() {
      ...
      if (visible && !document.hidden && !preference.matches) frameIdRef.current = requestAnimationFrame(tick);
    }
    ...
    function movePoints(time) {
      ...
      lines.forEach(pts => {
        pts.forEach(p => {
          const move = noise.perlin2((p.x / 0.6 + time * waveSpeedX) * 0.002, (p.y / 0.6 + time * waveSpeedY) * 0.0015) * 12;
